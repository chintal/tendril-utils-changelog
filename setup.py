...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-changelog',
    project_urls={
        'Documentation': 'https://tendril-utils-changelog.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-changelog/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-changelog',
    },
